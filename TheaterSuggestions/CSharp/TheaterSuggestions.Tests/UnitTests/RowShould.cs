...
namespace SeatsSuggestions.Tests.UnitTests
{
    ...
    public class RowShould
    {
        ...
        [Test]
        public void Offer_seats_from_the_middle_of_the_row_when_the_row_size__is_even_and_party_size_is_greater_than_one()
        {
            var partySize = 2;
        ...
        [Test]
        public void Offer_seats_from_the_middle_of_the_row_when_the_row_size_is_odd_and_party_size_is_greater_than_one()
        {
            var partySize = 5;
        ...
        public void Offer_adjacent_seats_nearer_the_middle_of_the_row_when_the_middle_is_not_reserved()
        {
            ...
            var seatsWithDistance = OfferSeatingPlacesNearerTheMiddleOfTheRow
                    .BuildSeatingPlaceCloserTheMiddleOfTheRow(row, suggestionRequest);
