...
import  com.octo.technology.SeatsSuggestions.DeepModel.*;
import com.octo.technology.SeatsSuggestions.DeepModel.OfferSeatingPlacesAdjacentFromTheMiddleOfTheRow;
...
public class Row {
    ...
    offerAdjacentSeatsNearerTheMiddleOfTheRow(SuggestionRequest suggestionRequest)
    {
        ...
        return OfferSeatingPlacesAdjacentFromTheMiddleOfTheRow
                .buildAdjacentSeats(seatWithTheDistanceFromTheMiddleOfTheRows, suggestionRequest.partyRequested());
    }
